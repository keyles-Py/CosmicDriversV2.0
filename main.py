...
import sys
from clases import nave, Estrella, Meteoro
...
def play_background_music():
    ...
    if not pygame.mixer.get_busy():
        songback = pygame.mixer.Sound("./media/Stay-Inside-Me.ogg")
...
def Main():
    ...
    icono = pygame.image.load("./assets/reicono.png").convert()
    ...
    wallpaperblur = pygame.image.load("./assets/image.png").convert()
    logo1 = pygame.image.load("./assets/Logo2.png").convert_alpha()
    logo2 = pygame.image.load("./assets/win.png").convert_alpha()
    logo3 = pygame.image.load("./assets/GameOver.png").convert_alpha()
    waifu = pygame.image.load("./assets/top3.png").convert_alpha()
    waifu3 = pygame.image.load("./assets/top33.png").convert_alpha()
    boton = pygame.image.load("./assets/Botonrere.png").convert_alpha()
    naveblur = pygame.image.load("./assets/blur.png").convert_alpha()
    #Fin Imagenes de la Pantalla de inicio
    waifuwin = pygame.image.load("./assets/YorXD.png").convert_alpha()
    wallpaper = pygame.image.load("./assets/8bitspace.png").convert()
    atras = pygame.image.load("./assets/backbutton.png").convert_alpha()
...
#Bucle principal del juego (Pantalla de inicio)
    ...
    while main:
        while Inicio:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    boton = pygame.image.load("./assets/Botonpressed.png").convert_alpha()
        ...
        while run:
            ...
            fuente = pygame.font.Font("./media/New_Wild_Words.ttf", 18)
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == K_UP or event.key == K_w:
                        nave1.rect.top -= 5
                        nave1.image = pygame.image.load("./assets/rocket_up.png").convert_alpha()
                        ...
                        nave1.rect.top += 5
                        nave1.image = pygame.image.load("./assets/rocket_down.png").convert_alpha()  
                        if estrellasenmapa == 0:
                                run = False
                                win = True
                        if colision:
                        ...
                        nave1.rect.left -= 5
                        nave1.image = pygame.image.load("./assets/rocket_left.png").convert_alpha()
                        if estrellasenmapa == 0:
                                run = False
                                win = True
                        if colision:
                        ...
                        nave1.rect.left += 5
                        nave1.image = pygame.image.load("./assets/rocket_right.png").convert_alpha()
                        if estrellasenmapa == 0:
                                run = False
                                win = True
                        if colision:
